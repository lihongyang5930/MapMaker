    ...
    public class RibbonManager
    {
        ...
        public void InitializeMenu()
        {
            ...
            foreach (ToolStripTabItem tab in this.RibbonControl.Header.MainItems)
            {
                if (tab.Name == "rbFile")
                {
                    group = tab.AddGroup("프로젝트 관리");
                    tool = group.AddButton(name: "mnuNewProject", text: "새프로젝트", image: MMaker.Core.Properties.Resources.icon_new_map);
                    tool = group.AddButton(name: "mnuOpenProject", text: "프로젝트 열기", image: MMaker.Core.Properties.Resources.img_folder_open32);
                ...
                {
                    group = tab.AddGroup("분석도구");
                    tool = group.AddButton(name: "mnuGrid", text: "GRID 생성", image: MMaker.Core.Properties.Resources._32_그리드생성);
                ...
                {
                    group = tab.AddGroup("편집도구");
                    tool = group.AddButton(name: "mnuEditStart", text: "편집시작", image: MMaker.Core.Properties.Resources.icon_pan1);
                    tool = group.AddButton(name: "mnuEditStop", text: "편집종료", image: MMaker.Core.Properties.Resources.icon_pan1);
                ...
                {
                    group = tab.AddGroup("도구");
                    tool = group.AddButton(name: "mnuEpanet", text: "EPANET 실행", image: MMaker.Core.Properties.Resources._32_EPANET2);
