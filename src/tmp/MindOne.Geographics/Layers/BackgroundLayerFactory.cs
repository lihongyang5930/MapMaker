...
namespace MindOne.Geographics.Layers
{
    public class BackgroundLayerFactory
    {
        ...
        public Task<BackgroundLayerSet> GetKakaoMap()
        {
            ...
            var sources     = new[] { 
                new HttpTileSource(schema, name: "map_2d"     , serverNodes: serverNodes, urlFormatter: "http://map{s}.daumcdn.net/map_2d/1906plw/L{z}/{y}/{x}.png"),
                new HttpTileSource(schema, name: "map_skyview", serverNodes: serverNodes, urlFormatter: "http://map{s}.daumcdn.net/map_skyview/L{z}/{y}/{x}.jpg?v=160114"),
                new HttpTileSource(schema, name: "map_hybrid" , serverNodes: serverNodes, urlFormatter: "http://map{s}.daumcdn.net/map_hybrid/1807hsm/L{z}/{y}/{x}.png")
            };
